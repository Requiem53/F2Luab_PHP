...
--
-- Host: 127.0.0.1
-- Generation Time: May 17, 2024 at 03:08 AM
...
(7, 'New game', 'mark feche', 121212, 'Developer', 'Publisher');
...
--
ALTER TABLE `tblpublishgame`
  MODIFY `gameID` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT for table `tbluseraccount`
--
ALTER TABLE `tbluseraccount`
  MODIFY `acctid` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=77;
